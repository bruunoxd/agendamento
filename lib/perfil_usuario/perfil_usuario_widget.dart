...
class _PerfilUsuarioWidgetState extends State<PerfilUsuarioWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.fotoPerfil = currentUserPhoto;
      _model.fotoAtual = currentUserPhoto;
      safeSetState(() {});
    });
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'Obs: Esse e-mail é para apenas contato, não muda o e-mail de login, \nvocê continuará logando com o mesmo e-mail cadastrado.',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Readex Pro',
                              fontSize: 10.0,
                              letterSpacing: 0.0,
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        ...
                        _model.fotoPerfil = _model.uploadedFileUrl;
                        safeSetState(() {});
                      },
                      child: Material(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await currentUserReference!
                          ...
                          displayName: _model.txtNomeTextController.text,
                          photoUrl: valueOrDefault<String>(
                            _model.fotoPerfil,
                            'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/agendamento-pdcu6o/assets/5hxt0ob2zai1/png-transparent-computer-icons-user-profile-others-miscellaneous-face-monochrome.png',
                          ),
                          phoneNumber: _model.txtTelefoneTextController.text,
                        ));
                        if (_model.uploadedFileUrl != '') {
                          await FirebaseStorage.instance
                              .refFromURL(_model.fotoAtual!)
                              .delete();
                        }
                        await showDialog(
                          context: context,
