...
import 'schema/profissoes_record.dart';
...
export 'schema/profissoes_record.dart';
...
/// Functions to query ProfissoesRecords (as a Stream and as a Future).
Future<int> queryProfissoesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ProfissoesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ProfissoesRecord>> queryProfissoesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ProfissoesRecord.collection,
      ProfissoesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ProfissoesRecord>> queryProfissoesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
